...
#line 8 "/mnt/c/repos/cp/q_test/Bell/Bell.qs"
            var current = M.Apply(q1);
#line 9 "/mnt/c/repos/cp/q_test/Bell/Bell.qs"
            if ((desired != current))
            {
#line 11 "/mnt/c/repos/cp/q_test/Bell/Bell.qs"
...
#line 17 "/mnt/c/repos/cp/q_test/Bell/Bell.qs"
            var numOnes = 0L;
#line 18 "/mnt/c/repos/cp/q_test/Bell/Bell.qs"
            var agree = 0L;
#line hidden
            {
#line 19 "/mnt/c/repos/cp/q_test/Bell/Bell.qs"
                var qubits = Allocate.Apply(2L);
#line 21 "/mnt/c/repos/cp/q_test/Bell/Bell.qs"
                foreach (var test in new Range(1L, count))
#line hidden
                {
#line 23 "/mnt/c/repos/cp/q_test/Bell/Bell.qs"
                    Set.Apply((initial, qubits[0L]));
#line 24 "/mnt/c/repos/cp/q_test/Bell/Bell.qs"
                    Set.Apply((Result.Zero, qubits[1L]));
#line 26 "/mnt/c/repos/cp/q_test/Bell/Bell.qs"
                    MicrosoftQuantumPrimitiveH.Apply(qubits[0L]);
#line 27 "/mnt/c/repos/cp/q_test/Bell/Bell.qs"
                    MicrosoftQuantumPrimitiveCNOT.Apply((qubits[0L], qubits[1L]));
#line 28 "/mnt/c/repos/cp/q_test/Bell/Bell.qs"
                    var res = M.Apply(qubits[0L]);
#line 30 "/mnt/c/repos/cp/q_test/Bell/Bell.qs"
                    if ((M.Apply(qubits[1L]) == res))
                    {
#line 32 "/mnt/c/repos/cp/q_test/Bell/Bell.qs"
                        agree = (agree + 1L);
                    }

#line 36 "/mnt/c/repos/cp/q_test/Bell/Bell.qs"
                    if ((res == Result.One))
                    {
#line 38 "/mnt/c/repos/cp/q_test/Bell/Bell.qs"
                        numOnes = (numOnes + 1L);
                    }
                }

#line 42 "/mnt/c/repos/cp/q_test/Bell/Bell.qs"
                Set.Apply((Result.Zero, qubits[0L]));
#line 43 "/mnt/c/repos/cp/q_test/Bell/Bell.qs"
                Set.Apply((Result.Zero, qubits[1L]));
#line hidden
                Release.Apply(qubits);
            }

#line 47 "/mnt/c/repos/cp/q_test/Bell/Bell.qs"
